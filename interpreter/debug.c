...
DebugTableSearchBreakpoint(struct ParseState *Parser, int *AddAt)
{
...
void
DebugSetBreakpoint(struct ParseState *Parser)
{
...
int
DebugClearBreakpoint(struct ParseState *Parser)
{
...
/* before we run a statement, check if there's anything we have to do with the
 * debugger here */
void
DebugCheckStatement(struct ParseState *Parser)
{
